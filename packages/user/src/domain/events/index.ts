 ...
 * 用户领域事件导出
 *
 * 导出所有用户相关的领域事件，用于事件发布和处理。
 *
 * @fileoverview 用户领域事件模块
 * @author AI开发团队
 * @since 1.0.0
 */
...
export { UserPreferencesUpdatedEvent } from './user-preferences-updated.event';
export { UserAssignedToTenantEvent } from './user-assigned-to-tenant.event';
